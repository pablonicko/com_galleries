...
namespace Pablotortul\Component\Galleries\Administrator\View\Orders;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_GALLERIES_TITLE_ORDERS'), "jcc fa-solid fa-list-radio");
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_galleries&view=orders');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`createdate`' => Text::_('COM_GALLERIES_ORDERS_CREATEDATE'),
			'a.`name`' => Text::_('COM_GALLERIES_ORDERS_NAME'),
			'a.`user_id`' => Text::_('COM_GALLERIES_ORDERS_USER_ID'),
			'a.`gallery_id`' => Text::_('COM_GALLERIES_ORDERS_GALLERY_ID'),
		);
	}
