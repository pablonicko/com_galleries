...
namespace Pablotortul\Component\Galleries\Administrator\View\Galleries;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_GALLERIES_TITLE_GALLERIES'), "jcc fa-solid fa-gallery-thumbnails");

		$toolbar = Toolbar::getInstance('toolbar');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/src/View/Galleries';
		...
		{
			$toolbar->preferences('com_galleries');
		}

		// Set sidebar action
		Sidebar::setAction('index.php?option=com_galleries&view=galleries');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => Text::_('COM_GALLERIES_GALLERIES_NAME'),
			'a.`user_id`' => Text::_('COM_GALLERIES_GALLERIES_USER_ID'),
		);
	}
